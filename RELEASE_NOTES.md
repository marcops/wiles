...
- **Preference Changes Made Right Before Quitting Could Be Lost**: Adjusting the icon-size slider, the sidebar width, or a List View column width and then quitting within a fraction of a second could lose that change on the next launch. Pending settings are now flushed on quit.
